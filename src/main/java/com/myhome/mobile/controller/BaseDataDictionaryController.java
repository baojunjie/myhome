...
@Controller(value = "questionnaireBasicDataController")
@RequestMapping(value = "/mobile/baseDataDictionary", produces = "text/html;charset=UTF-8")
public class BaseDataDictionaryController extends AbstractController {
	...
	public String getBaseDataDictionary(HttpServletRequest request, Model model) {
	...
	@ResponseBody
	public String getMobileEnterpriseSort(HttpServletRequest request, Model model) {
