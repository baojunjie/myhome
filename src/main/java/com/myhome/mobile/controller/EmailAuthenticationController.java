...
@Controller(value = "MobileEmailAuthenticationController")
@RequestMapping("/mobile/email/authentication")
public class EmailAuthenticationController extends AbstractController {

	private static Logger logger = LoggerFactory.getLogger(EmailAuthenticationController.class);
