...
@Controller("MobileSponsorsController")
@RequestMapping(value = "mobile/sponsors", produces = "text/html;charset=UTF-8")
public class SponsorsController extends AbstractController {
	...
	public String getMobileSponsors(Sponsors sponsors) {
		...
		try {
            ...
            Authentication loginMobile = super.getAuthenticationService().getByUseridAndType(sp.getUser().getId(), "2");
