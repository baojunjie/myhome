...
@Controller(value = "H5UserController")
@RequestMapping(value = "/H5/user", produces = "text/html;charset=UTF-8")
public class UserController extends AbstractController {
    ...
    @ResponseBody
    public String getMobileUser(HttpServletRequest request, HttpServletResponse response,User user) {
    ...
    @ResponseBody
    public String interceptoraddUserMobiel(HttpServletRequest request, HttpServletResponse response,
                                UserInfo userInfo) {
        ReturnData returnData = new ReturnData();
        response.addHeader("Access-Control-Allow-Origin", "*");
